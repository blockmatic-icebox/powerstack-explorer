...
var easeCurves = {
  'in-out-quint': { x1: 0.86, y1: 0, x2: 0.07, y2: 1 },
  'out-quint': { x1: 0.23, y1: 1, x2: 0.32, y2: 1 },
  'in-sine': { x1: 0.47, y1: 0, x2: 0.745, y2: 0.715 },
}
var space = {
  none: '0px',
  'xxx-small': '6px',
...
var shadows2 = {
  ...
  'drop-shadow-2': '0px 8px 16px 0px #0000003d, 4px 4px 4px 0px #00000021',
  'drop-shadow-3': '0px 12px 20px 0px #0000003d, 6px 6px 6px 0px #0000001f',
  'drop-shadow-4': '0px 16px 24px 0px #0000003d, 8px 8px 8px 0px #0000001f',
...
var dark_theme_default = {
  name: name2,
  typeStyles: typeStyles2,
  radii: radii2,
  shadows: shadows2,
  colors: colors2,
  fonts: fonts2,
  durations: durations2,
  easeCurves: easeCurves2,
  space: space2,
}
...
var { styled, globalCss, getCssText, config } = (0,
import_react.createStitches)({
  theme: {
...
var getFormData = (form) => {
  ...
  const signature =
    (_b = form.get('signature')) == null ? void 0 : _b.toString()
...
auth.use(
  new import_remix_auth_form.FormStrategy(async ({ form }) => {
    ...
    const addr = await import_ethers.ethers.utils.verifyMessage(
      message2,
      signature,
    )
    if (addr !== address)
...
auth.use(
  new import_remix_auth_form.FormStrategy(async ({ form }) => {
    const { address, signature, message: message2 } = getFormData(form)
    const resp2 = import_tweetnacl.default.sign.detached.verify(
      enc(message2),
      enc(signature),
      enc(address),
    )
...
var userAgent = isBrowser
  ? import_lodash.default.get(window, 'navigator.userAgent')
  : ''
...
var isPhantom =
  isBrowser && import_lodash.default.has(window, 'solana.isPhantom')
...
var createUserInterfaceSlice = (set) =>
  __spreadProps(__spreadValues({}, defaultUserInterfaceState), {
...
var createAppSessionSlice = (set) =>
  __spreadProps(__spreadValues({}, defaultAppSessionState), {
    setUser: (user) => set({ user }),
    setSessionData: (session_data) => set(session_data),
  })

// app/store/index.ts
var store = (0, import_vanilla.default)((set, get2) =>
  __spreadValues(
    __spreadValues({}, createAppSessionSlice(set, get2)),
    createUserInterfaceSlice(set, get2),
  ),
)
var useStoreBase = (0, import_zustand.default)(store)
if (isBrowser)
  (0, import_simple_zustand_devtools.mountStoreDevtool)(
    'AppStore',
    useStoreBase,
  )
var useStore = (0, import_auto_zustand_selectors_hook.createSelectorHooks)(
  useStoreBase,
)
...
function Header() {
  ...
  const AnchorItem = styled(
    'a',
    __spreadProps(__spreadValues({}, linkStyles), {
      '& svg': {
        size: '$iconSmall',
      },
    }),
...
function Index2() {
  ...
  return /* @__PURE__ */ React.createElement(
    ...
    /* @__PURE__ */ React.createElement('h1', null, 'Something'),
    /* @__PURE__ */ React.createElement(
      'pre',
      null,
...
var WalletLogin = () => {
  ...
  return /* @__PURE__ */ React.createElement(
    StyledWallet,
    null,
    /* @__PURE__ */ React.createElement('h3', null, 'Rinkeby'),
    /* @__PURE__ */ React.createElement(
      'button',
      {
    ...
    /* @__PURE__ */ React.createElement(
      ...
      (user == null ? void 0 : user.address) &&
        (user == null ? void 0 : user.network) === 'rinkeby'
        ? user.address
        : 'wallet not connected',
    ),
    /* @__PURE__ */ React.createElement('h3', null, 'Solana'),
    /* @__PURE__ */ React.createElement(
      'button',
      {
    ...
    /* @__PURE__ */ React.createElement(
      ...
      ' ',
      (user == null ? void 0 : user.address) &&
        (user == null ? void 0 : user.network) === 'solana'
        ? user.address
        : 'wallet not connected',
    ),
  )
...
function Index3() {
  ...
  return /* @__PURE__ */ React.createElement(
    ...
    /* @__PURE__ */ React.createElement(WalletLogin, null),
    /* @__PURE__ */ React.createElement(
      'ul',
      null,
      /* @__PURE__ */ React.createElement(
...
var assets_manifest_default = {
  version: '2d790f81',
  entry: {
    module: '/build/entry.client-NELYJJVT.js',
    imports: [
      '/build/_shared/chunk-4ACWVKRS.js',
      '/build/_shared/chunk-OG5HDHT3.js',
      '/build/_shared/chunk-HSYOKXM2.js',
      '/build/_shared/chunk-6SKE6JXS.js',
    ],
  },
  routes: {
    root: {
      ...
      module: '/build/root-W5JTOZYM.js',
      imports: ['/build/_shared/chunk-LBZBGASG.js'],
      hasAction: false,
      hasLoader: true,
    ...
    'routes/$account': {
      ...
      index: void 0,
      caseSensitive: void 0,
      module: '/build/routes/$account-JGY64W5Z.js',
      imports: void 0,
      hasAction: false,
      hasLoader: true,
    ...
    'routes/about': {
      ...
      index: void 0,
      caseSensitive: void 0,
      module: '/build/routes/about-UGLEDKRV.js',
      imports: ['/build/_shared/chunk-63VZOVCT.js'],
      hasAction: false,
      hasLoader: false,
      hasCatchBoundary: false,
      hasErrorBoundary: false,
    ...
    'routes/actions/login/$strategy': {
      ...
      index: void 0,
      caseSensitive: void 0,
      module: '/build/routes/actions/login/$strategy-Z6YG3TY5.js',
      imports: void 0,
      hasAction: true,
      hasLoader: false,
      hasCatchBoundary: false,
    ...
    'routes/index': {
      ...
      index: true,
      caseSensitive: void 0,
      module: '/build/routes/index-RU6YW7SP.js',
      imports: ['/build/_shared/chunk-63VZOVCT.js'],
      hasAction: false,
      hasLoader: false,
      hasCatchBoundary: false,
  ...
  url: '/build/manifest-2D790F81.js',
}
